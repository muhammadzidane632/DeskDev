    ...
    <div class="w-full max-w-[460px] bg-white border-2 border-black rounded-2xl shadow-[8px_8px_0px_0px_#000] z-20 pop-in flex flex-col overflow-hidden relative" style="animation-delay: 0.1s">
        ...
        <div class="p-6 sm:px-8 sm:py-6">
            ...
            <div class="space-y-2.5 mb-5">
                <a href="{{ route('auth.google') }}" class="btn-social w-full bg-white border-2 border-black text-black font-bold py-2 px-4 rounded-xl shadow-[2px_2px_0px_0px_#000] flex items-center justify-center gap-3 text-sm no-underline">
